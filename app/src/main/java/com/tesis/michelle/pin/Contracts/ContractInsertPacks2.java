...
public class ContractInsertPacks2 {
    ...
    public static class Columnas implements BaseColumns {
        ...
        public final static String CANTIDAD_ARMADA = "cantidad";
        public final static String CANTIDAD_ENCONTRADA = "cantidad_encontrada";
