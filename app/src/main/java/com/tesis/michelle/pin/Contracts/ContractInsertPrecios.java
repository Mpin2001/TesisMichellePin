 ...
 */
public class ContractInsertPrecios {
    /**
     * Representación de la tabla a consultar
     */
    public static final String INSERT_PRECIOS = "insert_precios";
    /**
    ...
    public static class Columnas implements BaseColumns {
        ...
        public final static String FABRICANTE = "fabricante"; //NUEVO SPINNER
        public final static String PRECIO_DESCUENTO = "precio_descuento"; //PARA GUARDAR EL EDITEXT DEL PRECIO CON DESCUENTO
        public final static String C_DESCUENTO = "c_descuento" ; //PARA GUARDAR EL CHECK
...
//        public final static String PSUGERIDO = "precio_sugerido";
        public final static String PREGULAR = "regular_price";
        public final static String PPROMOCION = "promotional_price";
        public final static String VAR_SUGERIDO = "var_sugerido";
