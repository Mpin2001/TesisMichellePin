...
public class AdapterProbadores extends RecyclerView.Adapter<AdapterProbadores.ViewHolder> {
    ...
    public AdapterProbadores(Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.status_probadores, viewGroup, false);
    ...
    //    String stock;
        ...
        //fechainicio = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.FECHACTIVIDAD));
        fecha = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.FECHA));
        hora = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.HORA));
        codigo= cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.SUPERVISOR));
      //  sku = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.USUARIO));
      //  tipo_promo = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.TIPO_PROMOCION));
        fabricante = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.TIPO_REGISTRO));
       // fabri = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.FABRICANTE));
        marca = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.MARCA));
       // subcategoria = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.SUBCATEGORIA));
        //mecanica = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.MECANICA));
      //  presentacion = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.DESCRIPCION_PROMOCION));
        cantidad = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.CANTIDAD));
        cantidad = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.CANTIDAD));
        fechavencimento = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.FECHA_VENCIMIENTO));
        lote = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.LOTE));
        comentario = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.COMENTARIO));
      //  brand = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.MARCA));
        sku_nuevo = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.SKU));
       // otras_marcas = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.OTRAS_MARCAS));
        //categoria = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.CATEGORIA));
        //ini_promo = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.INI_PROMO));
        //fin_promo = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.FIN_PROMO));
 //       stock = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.AGOTAR_STOCK));
        //campana = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.CAMPANA));
        //anterior = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.PVC_ANTERIOR));
        //actual = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertProbadores.Columnas.PVC_ACTUAL));
