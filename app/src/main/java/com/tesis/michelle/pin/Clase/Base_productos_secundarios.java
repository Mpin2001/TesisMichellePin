...
public class Base_productos_secundarios {
    ...
    public Base_productos_secundarios() {}

    public Base_productos_secundarios(String sku) {
        this.sku = sku;
    }

    public Base_productos_secundarios(String id, String sector, String categoria, String subcategoria,
                                      String segmento, String presentacion, String variante1, String variante2,
                                      String contenido, String sku, String marca, String fabricante, String pvp, String cadenas, String foto) {
        this.id = id;
        this.sector = sector;
