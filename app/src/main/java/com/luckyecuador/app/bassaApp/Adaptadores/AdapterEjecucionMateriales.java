...
public class AdapterEjecucionMateriales extends RecyclerView.Adapter<AdapterEjecucionMateriales.ViewHolder> {
    ...
    public AdapterEjecucionMateriales(Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.status_ejecucion_materiales, viewGroup, false);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        codigo = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertEjecucionMateriales.Columnas.CODIGO));
        fecha = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertEjecucionMateriales.Columnas.FECHA));
        hora= cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertEjecucionMateriales.Columnas.HORA));
        usuario = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertEjecucionMateriales.Columnas.USUARIO));
        tipo = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertEjecucionMateriales.Columnas.TIPO));
        producto = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertEjecucionMateriales.Columnas.MATERIAL));
        estado_material = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertEjecucionMateriales.Columnas.ESTADO_MATERIAL));
        prioridad = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertEjecucionMateriales.Columnas.PRIORIDAD));
